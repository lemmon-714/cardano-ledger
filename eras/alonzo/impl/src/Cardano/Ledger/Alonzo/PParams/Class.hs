...
class (EraPParams era) => AlonzoEraPParams era where
  hkdCoinsPerUTxOWordL :: Lens' (PParamsHKD f era) (HKD f Coin)
...
ppCoinsPerUTxOWordL :: forall era. AlonzoEraPParams era => Lens' (PParams era) Coin
...
ppuCoinsPerUTxOWordL :: forall era. AlonzoEraPParams era => Lens' (PParamsUpdate era) (StrictMaybe Coin)
